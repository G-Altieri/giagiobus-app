...
export function IconaLineeOutline({ size = 24, color = '#fff', ...props }) {
    return (
        <Svg
            width={size}
            height={size}
...
export function IconaLineeFill({ size = 24, color = '#fff', ...props }) {
    return (
        <Svg
            ...
            {...props}
        >
            <Path d="M12 0C5.437 0 3 2.168 3 8v33c0 1.36.398 2.34 1 3.063V47c0 1.652 1.348 3 3 3h4c1.652 0 3-1.348 3-3v-1h22v1c0 1.652 1.348 3 3 3h4c1.652 0 3-1.348 3-3v-2.938c.602-.722 1-1.703 1-3.062V9c0-4.355-.54-9-7-9zm3 4h21a1 1 0 011 1v2a1 1 0 01-1 1H15c-.55 0-1-.45-1-1V5c0-.55.45-1 1-1zm-4 7h28c2 0 3 1 3 3v12c0 2-1.953 2.938-3 2.938L11 29c-2 0-3-1-3-3V14c0-2 1-3 3-3zm-9 1c-1.102 0-2 .898-2 2v8c0 1.102.898 2 2 2zm46 0v12c1.105 0 2-.898 2-2v-8c0-1.102-.895-2-2-2zM11.5 34a3.5 3.5 0 110 7 3.5 3.5 0 110-7zm27 0a3.5 3.5 0 110 7 3.5 3.5 0 110-7z" />
        </Svg>
    );
}
export function IconaBusStopOutline({ size = 24, color = '#fff', ...props }) {
    return (
        <Svg
            width={size}
            height={size}
